...
const ProductCart  = ( {id,image,title,modelNumber,reviews,discount,price} ) => {
...
p="20px" pl="20px" h="40%"></Image>
    ...
    <Heading size='lg' mt="10px" mb="10px">${discount}</Heading>
    <Text ><Highlight query='Save $140'  styles={{bg:"red",color:"white",fontWeight:"bold"}}>Save $140</Highlight>${price}</Text>
